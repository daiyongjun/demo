...
adduser daiyongjun,passwd 1qaz2wsx
2、配置普通用户的sudo权限
#配置权限
...
#### 安装方式【Hadoop的发行版本】
本文档选择CDH的方式进行安装，基于tar包安装详细请看我前面的文档。HDP由于目前网上很少使用，故我们也不去考虑。
```
#Apache【目前免费】
基于HDFS等，详细见我们之前的文档
...
以上配置都是ClouderManger安装前建议步骤详细请看>[cloudera : 官方安装Documentation](https://docs.cloudera.com/documentation/enterprise/6/6.3/topics/configure_cm_repo.html#cm_repo "Hive的mysql安装配置")，后面步骤我们都会，按官方文档步骤来。除了遇到一些特殊的问题。你现在可以选择查看官方文档，或者继续。
