 ...
 * @author daiyongjun
 * @version 1.0
 * Created on date: 2020/3/7 19:26
 */
public class AnswerParser {
    ...
    static {
        registry = new NamedXContentRegistry(
                Stream.of(getDefaultNamedContents().stream(), getProvidedNamedContents().stream())
                        .flatMap(Function.identity()).collect(toList()));
    }

    /**
     * 解析   七牛的官方的reponse 响应的结果
     *
     ...
     */
    public static SearchResponse parseEntity(final com.qiniu.pandora.http.Response entity,
    ...
    private static List<NamedXContentRegistry.Entry> getDefaultNamedContents() {
     ...
     */
    private static List<NamedXContentRegistry.Entry> getProvidedNamedContents() {
