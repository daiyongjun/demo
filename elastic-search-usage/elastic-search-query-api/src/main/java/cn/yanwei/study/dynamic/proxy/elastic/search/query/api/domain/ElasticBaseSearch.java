...
import cn.yanwei.study.dynamic.proxy.elastic.search.query.api.annotation.*;
...
import static cn.yanwei.study.dynamic.proxy.elastic.search.query.api.constant.SortType.ASC;
import static cn.yanwei.study.dynamic.proxy.elastic.search.query.api.constant.SortType.DESC;
            ...
            if(f.isAnnotationPresent(Bool.class)){
                ...
                switch (bool.type()){
                    ...
                    case SHOULD_TERM:
                        ...
                        break;
                    case QUERY_STRING:
                        nestQb = queryStringQuery((String)value).defaultField(esFieldName).defaultOperator(Operator.AND);
                        break;
                    case MATCH:
